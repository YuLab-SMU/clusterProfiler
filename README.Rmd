...
[![releaseVersion](https://img.shields.io/badge/release%20version-`r check_bioc("clusterProfiler")$latest_version`-green.svg?style=flat)](https://bioconductor.org/packages/clusterProfiler)
[![develVersion](https://img.shields.io/badge/devel%20version-`r get_devel_version("GuangchuangYu/clusterProfiler")`-green.svg?style=flat)](https://github.com/GuangchuangYu/clusterProfiler)
...
[![citation](https://img.shields.io/badge/cited%20by-`r sum(get_article_cite_history('DO5oG40AAAAJ', 'MLfJN-KU85MC')$cites)`-green.svg?style=flat)](https://scholar.google.com.hk/scholar?oi=bibs&hl=en&cites=2349076811020942117)
...
[![download](http://www.bioconductor.org/shields/downloads/clusterProfiler.svg)](https://bioconductor.org/packages/stats/bioc/clusterProfiler/)
[![total](https://img.shields.io/badge/downloads-`r sum(bioc_stats("clusterProfiler")$Nb_of_downloads)`/total-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/clusterProfiler/)
[![month](https://img.shields.io/badge/downloads-`r x <- bioc_stats("clusterProfiler"); x$Nb_of_downloads[nrow(x)-1]`/month-blue.svg?style=flat)](https://bioconductor.org/packages/stats/bioc/clusterProfiler/)

```{r echo=F, comment=NA}
x <- bioc_stats("clusterProfiler")
