...
\Rfunction{enrichKEGG}, \Rfunction{enrichDO} and \Rfunction{enrichPathway} are similar. 
...
<<barplot, fig=TRUE, height=5, width=6>>=
barplot(ggo, drop=TRUE, showCategory=12)
@

\begin{figure}[ht]
\centering
\includegraphics[width=.6\textwidth]{clusterProfiler-barplot}
\caption{barplot of GO classification Result}
\label{barplot}
\end{figure}

<<barplot-enrich, fig=TRUE, height=5, width=8>>=
barplot(ego, showCategory=8)
@

\begin{figure}[ht]
\centering
\includegraphics[width=.6\textwidth]{clusterProfiler-barplot-enrich}
\caption{barplot of GO enrichment Result}
\label{barplot}
\end{figure}
...
<<cnetplot, fig=TRUE, height=14, width=14>>=
cnetplot(ego, categorySize="pvalue", foldChange=geneList)
@

\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{clusterProfiler-cnetplot}
\caption{cnetplot of GO enrichment result}
\label{cnetplot}
\end{figure}

<<cnetplot-KEGG, fig=TRUE, height=14, width=14>>=
cnetplot(kk, categorySize="geneNum", foldChange=geneList)
@

\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{clusterProfiler-cnetplot-KEGG}
\caption{cnetplot of KEGG enrichment result}
\label{cnetplot}
\end{figure}
\subsubsection{viewKEGG}
We developed \Rfunction{viewKEGG}, which extend functions of \Rpackage{Pathview} to support output of \Rfunction{enrichKEGG}, to automate visualize KEGG pathway.
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth,type=png,ext=.png,read=.png]{hsa04110.clusterProfiler}
\caption{viewKEGG in KEGG view}
\label{viewKEGG}
\end{figure}
\\
\\
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth,type=pdf,ext=.pdf,read=.pdf]{hsa04110.clusterProfiler}
\caption{viewKEGG in Graphviz view}
\label{viewKEGG}
\end{figure}

The parameter \Rparameter{pathwayID} can be numeric vector or character vector. If \Rparameter{pathwayID} is numeric value, \Rfunction{viewKEGG} will use it as index of \textit{KEGG enrichment result} and convert it to corresponding pathway ID. The \Rparameter{pathwayID} can also set to "all", and all the maps of significant pathways will be generated.
...
<<compareCluster, fig=TRUE, height=8, width=8>>=
data(gcSample)
...
\begin{figure}[ht]
\centering
\includegraphics[width=.9\textwidth]{clusterProfiler-compareCluster}
\caption{Comparison of KEGG enrichment of gene clusters}
