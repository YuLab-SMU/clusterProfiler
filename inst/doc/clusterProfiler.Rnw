...
% \VignetteDepends{AnnotationDbi, GO.db, org.Hs.eg.db, GOstats, ggplot2, methods, qvalue, KEGG.db, Category}
...
\begin{center}
<<fig=TRUE>>=
print(plot(xx, type="bar", by="count", caption="CC Ontology Enrichment Comparison using bar chart"))
@
\caption{Example of comparing CC ontology enrichment among gene clusters.}
