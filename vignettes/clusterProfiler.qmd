...
+ Topology-aware enrichment analysis
...
[the online book](https://yulab-smu.top/biomedical-knowledge-mining-book/) first.
Your problems are mostly documented. 
- If you think you found a bug, please provide a reproducible example to be posted
on [github issue tracker](https://github.com/GuangchuangYu/clusterProfiler/issues).
